...
router.post("/register", async (req, res) => {
    ...
    const mailOptions = {
        ...
        html: `<h3>Hey doc your are having a booking on ${date} want to conform if ypu want to take the meting link provided below</h3>  <a href="https://hospo-fbdf.onrender.com/conform/${email}/${phone}">click this</a><b> And </b><a href="https://hospo.vercel.app/meeting/${email}">meeting link</a>`
    };
...
router.get("/conform/:email/:phone", async (req, res) => {
    ...
    try {
        const mailOptions = {
            ...
            to: email,
            subject: 'New Registration',
            html: `Hey hi your schedule is done join meeting by clicking the lnk below on the scheduled date on 9:30 https://hospo-ten.vercel.app/meeting/${email.split("@")[0]}`
        };
        await transporter.sendMail(mailOptions);
